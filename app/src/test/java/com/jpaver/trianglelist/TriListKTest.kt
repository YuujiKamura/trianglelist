...
class TriListKTest {
    ...
    fun printTriLengthes( tri : TriangleK ){
        print( tri.lengthA_.toString() + tri.lengthB_.toString() + tri.lengthC_.toString() )
    }
    ...
    fun testTriArray(){
        ...
        trilist.triarray.forEach { ::printTriLengthes }
    }
...
//        mytri1.setNumber(55);
    ...
    fun testReverseNode() {
        ...
        trilist.reverse()
        Assert.assertEquals(trilist.get(3), trilist.get(1).nodeTriangle[2])
    ...
    fun testRemoveNode() {
        ...
        //trilist.remove( 2 )
        //assertEquals( 5f, trilist.get(1).nodeTriangle[1].lengthB_ )
    ...
    fun testResetPointAndAngleByNodeChain() {
        ...
        Assert.assertEquals(6f, trilist[1].lengthB_)
    ...
    fun testResetFromParamCase4() {
        ...
        Assert.assertEquals(8f, trilist[1].lengthB_)
        Assert.assertEquals(8f, trilist[3].lengthA_)
    ...
    fun testResetFromParamCase3() {
        ...
        //tri1△
        Assert.assertEquals(4.330f, trilist[1].pointBC_.y, 0.001f)
        Assert.assertEquals(0.000f, trilist[1].pointCA_.y, 0.001f)
        //tri2▽ △
        Assert.assertEquals(4.330f, trilist[2].pointCA_.y, 0.001f)
        Assert.assertEquals(0.000f, trilist[2].pointAB_.y, 0.001f)

        //　ケース３：二重断面中、7:BC、trilist.get(1)：△、(2)：▽△
        trilist.resetFromParam(Params("", "", 2, 6f, 6f, 6f, 1, 7))
        Assert.assertEquals(4.763f, trilist[2].pointCA_.y, 0.001f)
        Assert.assertEquals(-0.433f, trilist[2].pointAB_.y, 0.001f)

        //　ケース３：二重断面右、3:BR、trilist.get(1)：△、(2)：▽△
        trilist.resetFromParam(Params("", "", 2, 6f, 6f, 6f, 1, 3))
        Assert.assertEquals(4.330f, trilist[2].pointCA_.y, 0.001f)
        Assert.assertEquals(-0.866f, trilist[2].pointAB_.y, 0.001f)

        //　ケース３：二重断面左、4:BL、trilist.get(1)：△、(2)：▽△
        trilist.resetFromParam(Params("", "", 2, 6f, 6f, 6f, 1, 4))
        Assert.assertEquals(5.196f, trilist[2].pointCA_.y, 0.001f)
        Assert.assertEquals(0.000f, trilist[2].pointAB_.y, 0.001f)
    ...
    fun testResetFromParamCase2() {
        ...
        Assert.assertEquals(6f, trilist[3].lengthA_)
    ...
    fun testTriTreeReverse2() {
        ...
        Assert.assertEquals(5f, tritree.get(5).pointBC_.x, 0.001f)

        val revtree = tritree.reverse()

        Assert.assertEquals(5f, revtree.get(1).pointAB_.x, 0.001f)
    ...
    fun testTriTreeReverse() {
        ...
        Assert.assertEquals(5f, tritree.get(4).pointBC_.x, 0.001f)
    ...
    fun testTriListReverse(){
        ...
        Assert.assertEquals(1, triList.get(0).myNumber_) // ほんとはおかしいけどスルー
        Assert.assertEquals(1, triList.get(1).myNumber_)
        ...
        Assert.assertEquals(1, triList2.get(1).myNumber_)
        Assert.assertEquals(-1, triList2.get(1).parentNumber_)
        Assert.assertEquals(-1, triList2.get(2).parentNumber_)


        val triList3 = triList.numbered(5)
        Assert.assertEquals(5, triList3.get(1).myNumber_)
...
//        Assert.assertEquals("No.2", numlist[0].myName_ )
    ...
    fun testConnectionType3() {
        ...
        val tri8 =
                TriangleK(tri1, Params("", "", 2, 3f, 3f, 5f, 2, 5, tri1.pointCA_, PointXY(0f, 0f)))
        ...
        val tri7 =
                TriangleK(tri1, Params("", "", 2, 3f, 3f, 5f, 2, 6, tri1.pointCA_, PointXY(0f, 0f)))
    ...
    fun testConnectionType() {
        ...
        Assert.assertEquals(5f, tri2.nodeTriangle[0]!!.pointAB_.x, 0.0001f)
    ...
    fun testScale() {
        ...
        Assert.assertEquals(4f, myTrilist.getTriangle(1).pointBC_.y, 0.001f)
    }
    ...
    fun testGetTriangle() {
        ...
        Assert.assertEquals(3.0f, myTrilist.getTriangle(1).lengthA_, 0.001f)
    ...
    fun testReplaceA() {
        ...
        Assert.assertEquals(trilist.get(2).pointAB_.x, trilist.get(1).pointBC_.x, 0.001f)
        Assert.assertEquals(trilist.get(2).pointAB_.y, trilist.get(1).pointBC_.y, 0.001f)
    ...
    fun testReplace() {
        ...
        Assert.assertEquals(2.0f, myTrilist.getTriangle(1).lengthB_, 0.001f)
        Assert.assertEquals(3.0f, myTrilist.getTriangle(1).lengthA_, 0.001f)
        Assert.assertEquals(4.0f, myTrilist.getTriangle(3).lengthA_, 0.001f)
...
//        myTrilist.ResetTriangle(1, new TriangleK(6.0f, 4.0f, 5.0f, new PointXY(0,0), 180.0f));
    ...
    fun testTriangleList() {
        ...
        Assert.assertEquals(5.0, myTrilist.getTriangle(4).lengthA_.toDouble(), 0.001)
        ...
        Assert.assertEquals(3.0, myTrilist.getTriangle(3).lengthA_.toDouble(), 0.001)
    }
}