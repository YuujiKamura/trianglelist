...
*/
    ...
    operator fun set(
        ...
        if (nodeTriangleB_ != null) nodeTriangleB_!![this, nodeTriangleB_!!.parentBC, getLengthByIndex(
            nodeTriangleB_!!.parentSide
        ), nodeTriangleB_!!.lengthB_] = nodeTriangleB_!!.lengthC_
        if (nodeTriangleC_ != null) nodeTriangleC_!![this, nodeTriangleC_!!.parentBC, getLengthByIndex(
    ...
    fun resetByNode(pbc: Int) {
        ...
        if (node != null) {
            var length = getLengthByIndex(pbc)
    ...
    fun resetByParent(prnt: TriangleK, cParam: ConnParam): Boolean {
        if (!isValidLengthes(prnt.getLengthByIndex(parentSide), lengthB_, lengthC_)) return false
    ...
    fun resetByParent(prnt: TriangleK, pbc: Int): Boolean {
        ...
        val parentLength = prnt.getLengthByIndex(pbc)
    ...
    fun setConnectionType(cParam: ConnParam) {
        ...
        when (cParam.type) {
            0 -> if (cParam.lenA != 0.0f) {
                ...
                lengthA_ = nodeTriangleA_!!.getLengthByIndex(cParam.side)
                lengthAforce_ = nodeTriangleA_!!.getLengthByIndex(cParam.side)
    ...
    fun calcPoints(ref: TriangleK, refside: Int) {
        setNode(ref, refside)
        ...
        when (refside) {
            ...
            1 -> {
                ...
                plist = arrayOf(nodeTriangleB_!!.pointAB_, pointBC_, pointCA_)
            ...
            2 -> {
                ...
                plist = arrayOf(nodeTriangleC_!!.pointAB_, pointCA_, pointAB_)
