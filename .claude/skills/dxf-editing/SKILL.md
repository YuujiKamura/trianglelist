...
| 2 | 停止線 | No.0+2 | 左 | | 3 | 1 | W=45cm 白 |
| 3 | 車線分離線 | No.0+2 | 右折/右第一 | No.2 | 45 | 1 | W=15cm 白 |
...
| 車線指定 | 意味 | Y座標 |
|---------|------|-------|
| 左 | 左車線（対向） | CENTER_Y + 1500mm |
| 右 | 右車線 | CENTER_Y - 1500mm |
| (空欄) | 中央線上 | CENTER_Y |
...
|---------|------|-------|
| 左 | 左車線（対向） | CENTER_Y + 1500mm |
| 右折 | 右折レーン中央 | CENTER_Y - 1250mm (2500/2) |
| 右第一 | 第一走行帯中央 | CENTER_Y - 2500 - 残り幅/2 |
| 右折/右第一 | 車線分離線の位置 | CENTER_Y - 2500mm |
