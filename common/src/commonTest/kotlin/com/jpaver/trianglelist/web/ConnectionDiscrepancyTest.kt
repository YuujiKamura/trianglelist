...
class ConnectionDiscrepancyTest {
    ...
    @Test
    fun test_setOn_vs_EditObjectConstructor_SideB() {
        ...
        // --- Mixed Path (EditObject Constructor) ---
        // Side B(1), type(0), lcr(2) (Default for code 1)
        val cp = ConnParam(1, 0, 2, 8f)
        val triMixed = Triangle(parent as EditObject, cp, 7f, 5f)
    ...
    @Test
    fun test_setOn_vs_EditObjectConstructor_SideC() {
        val parent = Triangle(10f, 8f, 6f) 
        ...
        val triMixed = Triangle(parent as EditObject, cp, 5f, 4f)
