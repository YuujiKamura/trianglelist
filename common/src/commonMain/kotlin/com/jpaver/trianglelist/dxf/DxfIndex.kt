 ...
 */
// parseResult は desktopMain の DxfJvmIo.kt (saveToCache) から参照するため internal
open class DxfIndex(internal val parseResult: DxfParseResult) {
    ...
    // saveToCache / fromFile / fromCache (java.io.File / Properties / currentTimeMillis 依存) は
    // wasmJs 追加に伴い desktopMain の DxfJvmIo.kt へ extension として移設 (呼び出し形は同名のまま)。
    // companion object は extension の受け皿として残す
    companion object
}
